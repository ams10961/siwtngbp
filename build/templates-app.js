angular.module('templates-app', ['about/about.tpl.html', 'callbacks/twitter/callback.tpl.html', 'home/home.tpl.html', 'httperror/httperror.tpl.html', 'login/login.tpl.html']);
...
angular.module("callbacks/twitter/callback.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("callbacks/twitter/callback.tpl.html",
    "<!-- begin callback.tpl.html -->\n" +
    "\n" +
    "  <div class=\"signingIn\">\n" +
    "   	<p>Completing the sign-in with twitter process...</p>  \n" +
    "  </div>\n" +
    "\n" +
    "<!-- end callback.tpl.html -->");
}]);
...
angular.module("httperror/httperror.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("httperror/httperror.tpl.html",
    "<!-- begin httpError.tpl.html -->\n" +
    "\n" +
    "<div class=\"httpError\">\n" +
    "   <p>{{errorMessage}}</p>\n" +
    "</div>\n" +
    "\n" +
    "<!-- end httpError.tpl.html -->\n" +
    "\n" +
    "");
}]);
...
angular.module("login/login.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("login/login.tpl.html",
    "<!-- begin login.tpl.html -->\n" +
    "\n" +
    "<div class=\"twitterLogin\">\n" +
    "  <a ng-click=\"twitterLogin()\">\n" +
    "	<img alt=\"logo\" src=\"assets/img/sign-in-with-twitter-gray.png\"/>	\n" +
    "  </a>\n" +
    "</div>\n" +
    "\n" +
    "<!-- end login.tpl.html -->\n" +
